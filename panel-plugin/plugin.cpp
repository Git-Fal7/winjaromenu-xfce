	...
	m_window(NULL)
{
	...
	gtk_image_set_from_icon_name (m_button_icon,
                                  "distributor-logo-manjaro", GTK_ICON_SIZE_MENU);
	...
	m_menu_editor = new Command("xfce4-menueditor", _("Edit Applications..."), "menulibre", _("Failed to launch menu editor."), false, NULL);
